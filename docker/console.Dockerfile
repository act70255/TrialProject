...
COPY . .
RUN dotnet publish "src/CloudFileManager.Presentation/CloudFileManager.Presentation.Console/CloudFileManager.Presentation.Console.csproj" -c Release -o /app/publish /p:UseAppHost=false --no-restore
