...
COPY . .
RUN dotnet publish "src/CloudFileManager.Presentation/CloudFileManager.Presentation.WebApi/CloudFileManager.Presentation.WebApi.csproj" -c Release -o /app/publish /p:UseAppHost=false --no-restore
