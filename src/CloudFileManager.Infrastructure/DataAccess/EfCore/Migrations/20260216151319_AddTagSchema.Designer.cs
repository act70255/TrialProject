...
namespace CloudFileManager.Infrastructure.DataAccess.EfCore.Migrations
{
    ...
    [Migration("20260216151319_AddTagSchema")]
    partial class AddTagSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CloudFileManager.Infrastructure.DataAccess.EfCore.Entities.NodeTagEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("node_tags", null, t =>
                        {
                            t.HasCheckConstraint("CK_node_tags_single_target", "((DirectoryId IS NOT NULL AND FileId IS NULL) OR (DirectoryId IS NULL AND FileId IS NOT NULL))");
                        });
                });

            modelBuilder.Entity("CloudFileManager.Infrastructure.DataAccess.EfCore.Entities.TagEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("tags", null, t =>
                        {
                            t.HasCheckConstraint("CK_tags_color", "Color IN ('Red', 'Blue', 'Green')");

                            t.HasCheckConstraint("CK_tags_name", "Name IN ('Urgent', 'Work', 'Personal')");
                        });

                    b.HasData(
                        new
                        {
                            Id = new Guid("2c2c123c-45d6-4a89-8b9d-4d3b7fd72111"),
                            Color = "Red",
                            CreatedTime = new DateTime(2026, 2, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "Urgent"
                        },
                        new
                        {
                            Id = new Guid("74457bd5-0709-4afb-8a2f-7209f19766b6"),
                            Color = "Blue",
                            CreatedTime = new DateTime(2026, 2, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "Work"
                        },
                        new
                        {
                            Id = new Guid("17d22f5d-7fd0-4975-8f56-ce8ac2aa42e8"),
                            Color = "Green",
                            CreatedTime = new DateTime(2026, 2, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Name = "Personal"
                        });
            ...
            modelBuilder.Entity("CloudFileManager.Infrastructure.DataAccess.EfCore.Entities.NodeTagEntity", b =>
                {
                    ...
                    b.HasOne("CloudFileManager.Infrastructure.DataAccess.EfCore.Entities.TagEntity", "Tag")
                        .WithMany("NodeTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
